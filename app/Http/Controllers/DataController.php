...
class DataController extends Controller
{
    ...
    public function updateCircle( CircleRequest $request, Circle $circle, $subdomain=null): JsonResponse
    {
    ...
    public function updateUser(UserRequest $request, $subdomain, $address): JsonResponse
    {
        ...
        $data = $request->only('name','address','non_receiver','bio','epoch_first_visit','regift_percent');
        $data['address'] =  strtolower($data['address']);
